...
public class ImageUtil {
	...
	public static Bitmap getBitmap(String path) {
		Bitmap resizeBmp = null;
		try {
			resizeBmp = BitmapFactory.decodeFile(path);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return resizeBmp;
	...
	public static TransitionDrawable bitmapToTransitionDrawable(Bitmap bitmap) {
		...
		try {
			...
			mBitmapDrawable = new TransitionDrawable(new Drawable[] { new ColorDrawable(Color.TRANSPARENT),
