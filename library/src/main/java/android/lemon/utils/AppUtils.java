...
import android.lemon.bean.AppProcessInfo;
import android.lemon.bean.CPUInfo;
import android.lemon.bean.ProcessInfo;
import android.lemon.bean.PsRow;
...
public class AppUtils {
	...
	public static void killProcesses(Context context, int pid, String processName) {
		 ...
		 * AbLogUtiLog.d(AbAppUtil.class, "#kill -9 "+pid);
		 */
	...
	public static ProcessInfo getMemInfo(int pid) {
		...
		for (int i = 0; i < count; i++) {
			...
			// AbLogUtiLog.d(AbAppUtil.class, "##"+item[9]+",PID:"+tempPid);
	...
	public static List<String[]> parseProcessRunningInfo(String info) {
		...
		for (int i = 0; i < rows.length; i++) {
			tempString = rows[i];
			// AbLogUtiLog.d(AbAppUtil.class, tempString);
